...
class Channel final : noncopyable {
 public:
  ...
  static const char * const EXCHANGE_TYPE_DIRECT;
  static const char * const EXCHANGE_TYPE_FANOUT;
  static const char * const EXCHANGE_TYPE_TOPIC;
 ...
 protected:
  struct SSLConnectionParams final {
