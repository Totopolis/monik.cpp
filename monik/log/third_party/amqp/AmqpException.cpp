...
const std::uint16_t PreconditionFailedException::REPLY_CODE = AMQP_PRECONDITION_FAILED;
const std::uint16_t ConnectionForcedException::REPLY_CODE = AMQP_CONNECTION_FORCED;
...
const std::uint16_t UnexpectedFrameException::REPLY_CODE = AMQP_UNEXPECTED_FRAME;
...
AmqpResponseLibraryException::AmqpResponseLibraryException(
    const std::string &message) AMQP_NOEXCEPT
